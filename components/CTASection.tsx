  ...
  return (
    <section className="container-shell pb-16 sm:pb-20 lg:pb-24">
      <div className="overflow-hidden rounded-[2rem] bg-teal-800 px-6 py-14 text-center text-white shadow-2xl shadow-teal-900/20 sm:px-12">
        <p className="mb-3 text-sm font-bold uppercase tracking-[0.18em] text-teal-100">Start with one focused conversation</p>
        <h2 className="text-3xl font-black tracking-tight sm:text-4xl">Try Instant Mentor with a ₹69 single session.</h2>
        <p className="mx-auto mt-4 max-w-xl text-teal-50">Get personalized guidance without committing to a monthly plan. Choose a longer plan only when you need ongoing support.</p>
