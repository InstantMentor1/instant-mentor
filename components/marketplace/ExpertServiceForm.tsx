  ...
  return (
    <form onSubmit={handleSubmit} className="card space-y-6 p-6 sm:p-8">
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <Field label="Fixed menu price (Rs.)"><input required min="1" step="1" type="number" className="form-input" value={formData.price} onChange={(event) => update("price", event.target.value)} /></Field>
      ...
      <div className="rounded-2xl bg-ivory p-4 text-sm font-semibold text-navy">
        You set the fixed menu price. Estimated expert payout after platform commission is Rs. {pricePreview.smePayout.toLocaleString("en-IN")}.
      </div>
