  ...
  return (
    <article className="card relative flex h-full flex-col border-teal-200 p-6">
      ...
      <p className="mt-3 text-sm leading-6 text-slate-600">
        Pay ₹1 to confirm your interest in My Expert Talk Early Access.
      </p>
      <p className="mt-3 text-sm leading-6 text-slate-600">
        This unlocks early-access dashboard exploration for mentors, Expert Talks, and plans. Live mentor sessions are not included.
      </p>
      <ul className="my-5 flex-1 space-y-3 text-sm text-slate-700">
        ...
        <li className="flex gap-2"><Presentation size={17} className="shrink-0 text-teal-700" /> Explore Expert Talks and mentors</li>
