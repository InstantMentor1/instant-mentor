  ...
  return (
    <>
      <PageHero
        ...
        description="Browse mentor services for career support, academics, interviews, skills, business, finance, design, technology, and institution programs."
      />
        ...
        <div className="container-shell grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {marketplaceCategories.map((category) => (
            <Link key={category} href={`/services?category=${encodeURIComponent(category)}`} className="card p-6 transition hover:-translate-y-1 hover:border-teal-300">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">Compare mentors, outcomes, mentor-set prices, availability, and delivery formats.</p>
