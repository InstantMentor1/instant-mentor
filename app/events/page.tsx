...
const events = [
  ["Resume clinic for students", 2, "6:00 PM", "Aarav Mehta"],
  ["AI tools for learning", 4, "7:30 PM", "Rohan Iyer"],
  ["Exam strategy room", 7, "5:00 PM", "Sneha Patel"],
] as const;
