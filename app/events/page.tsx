        ...
        <div className="container-shell grid gap-5 md:grid-cols-3">
          {events.map(([title, date, time, speaker]) => (
            <article key={title} className="card flex gap-4 p-6">
              <div className="flex h-16 w-16 shrink-0 flex-col items-center justify-center rounded-2xl bg-coral text-white">
              ...
              <div>
                ...
                <button className="mt-3 text-sm font-black text-coral">Register / Learn More</button>
              </div>
            </article>
          ))}
        </div>
